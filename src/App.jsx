...
import { getFirestore, collection, query, where, onSnapshot, addDoc, deleteDoc, doc, getDocs, setDoc, updateDoc, getDoc, setLogLevel } from 'firebase/firestore';

// Tailwind CSS is assumed to be available, so no explicit import is needed.
...
  const APP_ID = 'newsapps-ae8a7';
  const FIREBASE_CONFIG = {
    apiKey: "AIzaSyDwOV6kOJJjFMTZPdbm3jMihzZt7CFzLqQ",
    authDomain: "newsapps-ae8a7.firebaseapp.com",
    projectId: "newsapps-ae8a7",
    storageBucket: "newsapps-ae8a7.appspot.com",
    messagingSenderId: "853126367373",
    appId: "1:853126367373:web:5b9e0f66a2e2d93e8e19e9" // Placeholder - will be populated by Firebase
  };
...
  // Ref to store comment input elements
...
      setLogLevel('debug'); // Add logging for debugging Firestore
...
            // 오류가 발생해도 userId를 설정하여 앱이 계속 작동하도록 함
...
      dataMapping = {
        title: 0, newsContent: 1, detailedContent1: 2, detailedContent2: 3,
        detailedContent3: 4, detailedContent4: 5, detailedContent5: 6,
        url: 7, imageUrl: 8, date: 9,
      };
    } else {
      dataMapping = {
        title: 0, keyword: 1, source: 2, tags: 3, url: 4, date: 5,
        summary: 6, content: 7, imageUrl: 8, nickname: 9, companyName: 10,
        jobTitle: 11, recommendationStrength: 12, recommendationReason: 13, likes: 14,
      };
    }
...
      { id: "news-all-0-2025-08-01-네이버, AI", title: "네이버, AI 검색 서비스 대폭 개선... 정확도 30% 향상", keyword: "네이버", source: "IT조선", tags: "#AI #검색 #기술혁신 #추천", url: "https://example.com/news1", date: today.toISOString().split('T')[0], time: '16:10', summary: "네이버가 자체 개발한 AI 기술을 적용하여 검색 정확도를 크게 개선했으며, 사용자 만족도가 크게 향상될 것으로 예상됩니다.", content: "이는 대규모 언어 모델(LLM)과 최신 검색 알고리즘을 결합한 결과입니다. 사용자들은 이제 더 빠르고 정확한 정보를 얻을 수 있을 것으로 기대됩니다.", imageUrl: "https://placehold.co/100x80/2DB400/FFFFFF?text=NAVER_NEWS", nickname: "개발자김", companyName: "네이버", jobTitle: "AI 개발자", recommendationStrength: 5, recommendationReason: "이 기사는 AI 검색의 미래를 보여줍니다.", likes: 12 },
      { id: "news-all-1-2025-08-01-토스, 투자", title: "토스, 투자 플랫폼 '토스증권' 월 거래액 10조원 돌파", keyword: "토스", source: "매일경제", tags: "#핀테크 #투자 #거래액 #추천", url: "https://example.com/news2", date: today.toISOString().split('T')[0], time: '16:00', summary: "토스증권이 월 거래액 10조원을 돌파하며 핀테크 시장의 새로운 강자로 떠올랐습니다.", content: "간편한 인터페이스와 다양한 투자 상품으로 2030 세대의 높은 지지를 받고 있으며, 시장 점유율을 빠르게 확대하고 있습니다.", imageUrl: "https://placehold.co/100x80/0046FF/FFFFFF?text=TOSS_NEWS", nickname: "투자박", companyName: "토스", jobTitle: "증권 애널리스트", recommendationStrength: 4, recommendationReason: "핀테크 투자의 중요성을 강조합니다.", likes: 8 },
      { id: "news-all-2-2025-08-01-카카오, 새로운", title: "카카오, 새로운 소셜 서비스 '카카오뷰' 출시", keyword: "카카오", source: "전자신문", tags: "#소셜 #플랫폼 #신규서비스", url: "https://example.com/news3", date: today.toISOString().split('T')[0], time: '15:30', summary: "카카오가 콘텐츠 큐레이션 기반의 새로운 소셜 서비스 '카카오뷰'를 출시하며 플랫폼 영향력 강화에 나섰습니다.", content: "사용자들이 직접 콘텐츠를 큐레이션하고 발행할 수 있는 기능을 제공하며, 새로운 정보 소비 방식을 제안합니다.", imageUrl: "https://placehold.co/100x80/F9E000/000000?text=KAKAO_NEWS", nickname: "콘텐츠이", companyName: "카카오", jobTitle: "서비스 기획자", recommendationStrength: 3, recommendationReason: "새로운 소셜 경험을 위한 필수 서비스.", likes: 25 },
      { id: "news-all-3-2025-08-01-당근마켓, 지역", title: "당근마켓, 지역 커뮤니티 활성화로 월 사용자 2천만 명 달성", keyword: "당근마켓", source: "블로터", tags: "#커뮤니티 #중고거래 #추천", url: "https://example.com/news4", date: yesterday.toISOString().split('T')[0], time: '10:00', summary: "당근마켓이 단순 중고거래를 넘어 지역 커뮤니티 플랫폼으로 자리매김하며 월간 활성 사용자(MAU) 2천만 명을 돌파했습니다.", content: "이웃과의 소통과 정보 교환을 통해 지역 생활에 필수적인 앱으로 성장했으며, 다양한 연령대의 사용자를 확보하고 있습니다.", imageUrl: "https://placehold.co/100x80/FF6F00/FFFFFF?text=DAANGN_NEWS", nickname: "마케터정", companyName: "당근마켓", jobTitle: "마케팅 전문가", recommendationStrength: 5, recommendationReason: "지역 기반 서비스의 성공 사례입니다.", likes: 40 },
      { id: "news-all-4-2025-08-01-새로운 기술", title: "새로운 기술 동향, 블록체인 기반 서비스 확산", keyword: "블록체인", source: "테크월드", tags: "#블록체인 #기술동향", url: "https://example.com/news5", date: yesterday.toISOString().split('T')[0], time: '09:00', summary: "블록체인 기술이 다양한 산업 분야로 확산되며 새로운 서비스 모델을 제시하고 있습니다.", content: "금융, 유통, 제조 등 여러 분야에서 블록체인 기반의 혁신적인 솔루션이 등장하고 있으며, 이에 대한 기대감이 커지고 있습니다.", imageUrl: "https://placehold.co/100x80/4A90E2/FFFFFF?text=BLOCKCHAIN", nickname: "", companyName: "", jobTitle: "", recommendationStrength: 0, recommendationReason: "", likes: 7 },
      { id: "news-all-5-2025-08-01-클라우드 서비스", title: "클라우드 서비스, 기업 디지털 전환 핵심으로 부상", keyword: "클라우드", source: "디지털데일리", tags: "#클라우드 #디지털전환", url: "https://example.com/news6", date: yesterday.toISOString().split('T')[0], time: '08:00', summary: "클라우드 컴퓨팅이 기업의 디지털 전환을 가속화하는 핵심 기술로 주목받고 있습니다.", content: "유연성과 확장성을 바탕으로 기업 IT 인프라의 효율성을 극대화하며, 새로운 비즈니스 기회를 창출하고 있습니다.", imageUrl: "https://placehold.co/100x80/FF9900/FFFFFF?text=CLOUD", nickname: "클라우드김", companyName: "AWS", jobTitle: "클라우드 아키텍트", recommendationStrength: 4, recommendationReason: "클라우드 도입을 고민하는 기업에게 필독!", likes: 15 },
    ];

    const deepSimulatedData = [
      { id: "news-deep-0", title: "Deep Learning, 의료 진단 혁신을 이끌다", newsContent: "최신 딥러닝 기술이 의료 영상 분석에 적용되어 질병 진단 정확도를 크게 높이고 있습니다.", detailedContent1: "알파고가 의료 분야에 적용된 이후, 인공지능 기반의 진단 보조 시스템은 암 조기 발견, 희귀 질환 진단 등 다양한 영역에서 인간 의사의 역량을 보완하며 혁신을 가져오고 있습니다.", detailedContent2: "특히, 딥러닝 모델은 방대한 의료 데이터를 학습하여 미세한 패턴까지 인식함으로써 진단의 신뢰도를 향상시키고 있습니다.", detailedContent3: "이러한 기술 발전은 의료 서비스의 접근성을 높이고, 개인 맞춤형 치료의 가능성을 열어줄 것입니다.", detailedContent4: "", detailedContent5: "", url: "https://example.com/deep1", imageUrl: "https://img.hankyung.com/photo/202508/01.41398148.1.jpg", date: "2025-08-22", time: "11:00" },
      { id: "news-deep-1", title: "자율주행 기술, 딥러닝으로 안전성 강화", newsContent: "자율주행 자동차의 인지 및 판단 시스템이 딥러닝 알고리즘을 통해 더욱 정교해지고 있습니다.", detailedContent1: "테슬라, 구글 웨이모 등 선두 기업들은 딥러닝 기반의 컴퓨터 비전과 센서 퓨전 기술을 활용하여 복잡한 도로 상황을 정확하게 인식하고 예측하는 데 집중하고 있습니다.", detailedContent2: "이는 악천후, 야간 주행 등 다양한 환경에서도 안정적인 자율주행을 가능하게 하며, 사고 발생률을 획기적으로 줄일 것으로 기대됩니다.", detailedContent3: "하지만 법적, 윤리적 문제 해결과 사회적 수용성 확보가 여전히 중요한 과제로 남아있습니다.", detailedContent4: "", detailedContent5: "", url: "https://example.com/deep2", imageUrl: "https://placehold.co/600x300/6C757D/FFFFFF?text=AUTONOMOUS", date: "2025-08-21", time: "14:30" },
      { id: "news-deep-2", title: "생성형 AI, 콘텐츠 산업의 판도를 바꾸다", newsContent: "텍스트, 이미지, 비디오 등 다양한 형태의 콘텐츠를 생성하는 AI 기술이 빠르게 발전하고 있습니다.", detailedContent1: "달리(DALL-E), 미드저니(Midjourney)와 같은 생성형 AI 모델들은 예술, 디자인, 마케팅 등 콘텐츠 제작 전반에 혁신을 가져오고 있습니다.", detailedContent2: "사용자의 간단한 지시만으로 고품질의 결과물을 만들어내며, 창작의 경계를 확장하고 새로운 비즈니스 기회를 창출하고 있습니다.", detailedContent3: "특히 개인화된 콘텐츠 제작과 효율적인 워크플로우 구축에 기여하며, 미래 콘텐츠 시장의 핵심 동력이 될 것입니다.", detailedContent4: "하지만 저작권 문제와 AI 윤리 가이드라인 마련이 시급한 상황입니다.", detailedContent5: "이러한 과제들을 해결하며 생성형 AI는 더욱 발전할 것입니다.", url: "https://example.com/deep3", imageUrl: "https://placehold.co/600x300/FFC107/000000?text=GENERATIVE_AI", date: "2025-08-18", time: "09:45" },
    ];
...
      const latest = dataToLoad.sort((a, b) => new Date(b.date + 'T' + b.time) - new Date(a.date + 'T' + a.time))[0].date;
      setLatestDate(latest);
    }
    setLoading(false);
  }, []);
...
    if (activeTab === "subscribe") return news.nickname && news.companyName && news.jobTitle && news.recommendationReason && news.recommendationStrength > 0;
    if (activeTab === "deep") return news.title && news.newsContent && (news.detailedContent1 || news.detailedContent2 || news.detailedContent3 || news.detailedContent4 || news.detailedContent5) && news.imageUrl;
    return true;
  });

  // 시간 단위로 뉴스를 그룹화하는 함수
  const groupNewsByHour = (newsItems) => {
    const groups = newsItems.reduce((acc, news) => {
      // date와 time 필드를 결합하여 Date 객체 생성
      const newsDateTime = new Date(`${news.date}T${news.time}`);
      // 시간 단위로 그룹화하기 위한 키 생성
      const groupKey = newsDateTime.getFullYear() + '-' +
        (newsDateTime.getMonth() + 1).toString().padStart(2, '0') + '-' +
        newsDateTime.getDate().toString().padStart(2, '0') + ' ' +
        newsDateTime.getHours().toString().padStart(2, '0') + '시';
      
      if (!acc[groupKey]) {
        acc[groupKey] = [];
      }
...
  const sortedGroups = Object.keys(groupedNews).sort((a, b) => {
    // 'YYYY-MM-DD HH시' 형식의 키를 Date 객체로 변환하여 비교
    const dateA = new Date(a.replace(' ', 'T') + ':00');
    const dateB = new Date(b.replace(' ', 'T') + ':00');
    return dateB - dateA;
  });

  // 시간대 헤더를 포맷하는 함수 (예: '2025-08-01 15:00' -> '오후 3시')
...
          {["all", "recommended", "subscribe", "deep", "bookmarks"].map(tab => (
            <button
              key={tab}
...
                  <section key={groupKey} className="max-w-4xl mx-auto mb-8">
                      <h2 className="text-lg font-bold text-gray-700 mb-3 pl-2 border-l-4 border-blue-500">{formatGroupHeader(groupKey)}</h2>
                      <div className="space-y-4">
                          {groupedNews[groupKey].slice(0, showMoreCounts[groupKey] || 10).map((news) => (
...
                                          <img src={news.imageUrl} alt={news.title} className="max-w-full h-auto object-contain rounded-md max-h-72" onError={(e) => { e.target.onerror = null; e.target.src = `https://placehold.co/600x300/E2E8F0/64748B?text=No+Img`; }} />
                                        </div>
                                      )}
...
                                        {news.imageUrl && (
                                          <img src={news.imageUrl} alt={news.title} className="w-24 h-20 object-cover rounded-md flex-shrink-0" onError={(e) => { e.target.onerror = null; e.target.src = `https://placehold.co/100x80/E2E8F0/64748B?text=No+Img`; }} />
                                        )}
...
                                          {(activeTab === 'subscribe' || activeTab === 'all' || activeTab === 'recommended' || activeTab === 'bookmarks') && news.date && news.time && (
                                            <span className="text-gray-500 text-xs flex-shrink-0">{news.date} {news.time}</span>
                                          )}
                                      </div>
                                  </div>
...
                                        {[...Array(5)].map((_, i) => (
                                          <StarIcon key={i} size={16} className={i < news.recommendationStrength ? "text-yellow-300 fill-current" : "text-gray-300"} />
                                        ))}
                                      </div>
                                    </div>
                                  )}
...
                              </Card>
                          ))}
                          {groupedNews[groupKey].length > (showMoreCounts[groupKey] || 10) && (
                              <div className="text-center mt-4">
                                  <button onClick={() => handleLoadMore(groupKey)} className="px-6 py-2 bg-gray-200 text-gray-800 rounded-full font-semibold hover:bg-gray-300 transition-colors">더 불러오기 ({groupedNews[groupKey].length - (showMoreCounts[groupKey] || 10)}개 남음)</button>
                              </div>
                          )}
                      </div>
                  </section>
